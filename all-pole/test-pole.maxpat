...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 782.0, 66.0, 335.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 307.0, 15.0, 335.0, 40.0 ],
					"text" : "OUTPUT",
					"textcolor" : [ 0.501961, 0.0, 0.25098, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 767.0, 51.0, 335.0, 40.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 52.0, 265.0, 335.0, 40.0 ],
					"text" : "INPUT",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 757.0, 445.0, 123.0, 21.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "bang" ],
									"patching_rect" : [ 50.0, 64.0, 60.0, 20.0 ],
									"text" : "loadbang"
								}
...
,
					"patching_rect" : [ 302.0, 147.0, 50.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 276.0, 3.0, 85.0, 20.0 ],
					"text" : "loadmess 440"
				}
...
,
					"patching_rect" : [ 416.5, 473.0, 58.0, 21.0 ],
					"saved_object_attributes" : 					{
						"default_fontface" : 0,
						"default_fontname" : "Arial",
						"default_fontsize" : 13.0,
...
, 			{
				"box" : 				{
					...
					"numpoints" : 512,
					"outlettype" : [ "" ],
					"patching_rect" : [ 403.0, 565.0, 657.0, 389.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 5.0, 4.0, 657.0, 389.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 403.0, 445.0, 123.0, 21.0 ],
					"text" : "windowed-fft~ 1024"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.0, 218.0, 45.0, 20.0 ],
					"text" : "allpole"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 345.0, 63.5, 48.0, 136.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 687.0, 4.0, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "signal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 276.0, 276.0, 48.0, 136.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 687.0, 257.0, 48.0, 136.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 276.0, 29.0, 46.0, 20.0 ],
					"text" : "noise~"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 465.0, 552.0, 1050.5, 552.0 ],
					"source" : [ "obj-16", 1 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-6" : [ "live.gain~[1]", "Input", 0 ],
			"obj-5" : [ "Output", "Output", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "allpole.maxpat",
				"bootpath" : "/Users/victor/Google Drive/stage-m1/VOKantor/all-pole",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
